...
class NoticeController extends Controller
{
	...
	public function actionDelNotice(){
		...
		$reqMsgStr = HttpUtils::makeNetMsg($req,$cmd::CMD_B2M_RemoveAnnouncement_Request);
		$respMsgStr = HttpUtils::sendNetMsg($reqMsgStr);
    ...
    public function actionModifyNotice(){
         ...
         * @var binary
         */
        $reqMsgStr = HttpUtils::makeNetMsg($req,$cmd::CMD_B2M_ModifyAnnouncement_Request);
        /**
         * 发送消息
         * @var binary
         */
    ...
    public function actionGetNoticeData(){
         ...
         * @var binary
         */
        $reqMsgStr = HttpUtils::makeNetMsg($req,$cmd::CMD_B2M_GetAnnouncement_Request);
        /**
         * 发送消息
         * @var binary
         */
    ...
    public function actionGetRollingBulletin(){
         ...
         * @var binary
         */
        $reqMsgStr = HttpUtils::makeNetMsg($req,$cmd::CMD_B2M_GetRollingBulletin_Request);
        /**
         * 发送消息
         * @var binary
         */
    ...
    public function actionSetRollingBulletin(){
         ...
         * @var binary
         */
        $reqMsgStr = HttpUtils::makeNetMsg($req,$cmd::CMD_B2M_SetRollingBulletin_Request);
        /**
         * 发送消息
         * @var binary
         */
